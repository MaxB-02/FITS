...
// Safe fallbacks for production if env vars are missing (temporary)
const DEFAULT_ADMIN_USERNAME = process.env.ADMIN_USERNAME || 'Admin1';
const DEFAULT_ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'Test1!!';
const DEFAULT_ADMIN_EMAILS = process.env.ADMIN_EMAILS || 'admin@example.com';
const secret = new TextEncoder().encode(process.env.SESSION_SECRET || 'change-me-session-secret');
